...
destructors.  Fields containing zero-length bit-fields or zero-length array are
...
NOTE: One exceptional case for the flattening rule is the array with empty
structs or unions; C language treats it as an empty field, but {Cpp} language
